<template>
  <!-- <div class="home"> -->
    ...
    <!-- </div> -->
  <!-- </div> -->
  <div class="edit" ref="content" contenteditable="true">
    <span v-for="(i, index) in data" :key="index" :class="i.cl">{{ i.text }}</span>
  </div>
  <button @click="convertClick">Convert</button>
</template>
...
//const text = ref('Test<span class="blue">ing</span>')
...
const scopeId = (getCurrentInstance() as any).ctx.$options.__scopeId

//console.log(instance.ctx.$options.__scopeId)
//console.log(instance?.vnode.type.__scopeId)

// onMounted(() => {
  //const span = document.createElement("span");
  //console.log("scope_id", binding.value.instance.$options.__scopeId);
  //console.log(Object.getOwnPropertyNames(content.value))
  //console.log((content.value as any).__vnode)
  //console.log(this)
...
data.value.push({cl:'edt-green', text:'Test'})
data.value.push({cl:'edt-blue', text:'ing'})
data.value.push({cl:'', text:' Two'})

function convertClick() {
  if (content.value == null) return
  console.log(content.value.innerText)
  console.log(content.value.innerHTML)
  // let html = content.value.innerHTML
  // const pos = html.indexOf('Test')
  // if (pos >=0 && !(pos>0 && html.substr(pos-1, 1) === '>')) {
  //   // let data = ''
  //   // console.log(content.value.attributes)
  //   // for (let attr of content.value.attributes) {
  //   //   if (attr.name.startsWith('data-')) {
  //   //     data = attr.name+'=""'
  //   //     console.log(attr)
  //   //   }
  //   // }
  //   html = html.substr(0, pos) + '<span ' + scopeId + ' class="edt-green">' + html.substr(pos, 4) + '</span>' + html.substr(pos+4)
